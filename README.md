...
# Booking.com - Web - Lesson 2 - Exercise - Typescript

This repository contains the solution to the second practical exercise related to filling in the contact form.
...
```sh
git clone https://github.com/Manual-To-Automation-Booking-Amsterdam/Web-Lesson-2-Exercise-TS.git
```

Move into the directory:

```sh
cd Web-Lesson-2-Exercise-TS
```
